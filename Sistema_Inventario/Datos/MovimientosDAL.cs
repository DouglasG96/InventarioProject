...
namespace Datos
{
    ...
    {
        //metodo para cargar listado de movimientos
        ...
        public static vw_movimientos detalleMovimientos(int id)
        {
            using (inventarioEntities bd = new inventarioEntities())
            {
                /*
                var movimiento = bd.vw_movimientos.First(x => x.id_producto == id);
